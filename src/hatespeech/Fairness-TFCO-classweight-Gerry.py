...
def constrained_optimization(lang, odir, nu=0.0001, weighted=True):
    ...
    contexts_available = [context_subset_0, context_subset_1, context_subset_2, context_subset_3, context_subset_4, context_subset_5, context_subset_6, context_subset_7, context_subset_8,
                        context_subset_9, context_subset_10, context_subset_11, context_subset_12, context_subset_13, context_subset_14, context_subset_15, context_subset_16, context_subset_17,
                        context_subset_18, context_subset_19, context_subset_20, context_subset_21, context_subset_22, context_subset_23, context_subset_24, context_subset_25, context_subset_26,
                        ...
                        context_subset_60, context_subset_61, context_subset_62, context_subset_63, context_subset_64, context_subset_65, context_subset_66, context_subset_67,
                        context_subset_68, context_subset_69, context_subset_70, context_subset_71, context_subset_72, context_subset_73, context_subset_74, context_subset_75, context_subset_76,
                        context_subset_77, context_subset_78, context_subset_79]
    ...
    while e < NUM_ITERATIONS:
        ...
        with open(odir+'hatespeech_tfco_gerry_cw_{}_tw_{}_{}.tsv'.format(weighted, e, nu), 'w') as wfile:
    ...
    with open(odir+'validation_hatespeech_tfco_gerry_cw_{}_{}.pkl'.format(weighted, nu), 'wb') as f:
