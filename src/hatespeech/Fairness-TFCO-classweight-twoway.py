...
def constrained_optimization(lang, odir, nu=0.0001, weighted=True):
    ...
    contexts_available = [context_subset_0, context_subset_1, context_subset_2, context_subset_3, context_subset_4, context_subset_5, context_subset_6, context_subset_7, context_subset_8, \
                        context_subset_9, context_subset_10, context_subset_11, context_subset_12, context_subset_13, context_subset_14, context_subset_15]
    ...
    while e < NUM_ITERATIONS:
        ...
        with open(odir+'hatespeech_tfco_intersectional_cw_{}_tw_{}_{}.tsv'.format(weighted, e, nu), 'w') as wfile:
        ...
        evaluator.eval(
            odir+'hatespeech_tfco_intersectional_cw_{}_tw_{}_{}.tsv'.format(weighted, e, nu), 
            odir+'hatespeech_tfco_intersectional_cw_{}_tw_{}_{}.score'.format(weighted, e, nu)
        )
    
    with open(odir+'validation_hatespeech_tfco_intersectional_cw_{}_{}.pkl'.format(weighted, nu), 'wb') as f:
